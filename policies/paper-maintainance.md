...
5. **(Required) Make your code and data available on GitHub** with good structures: there should be a README.md to explain the code and data, requirements.txt for creating the environment, and sample code in README.md to run your code.
