...
* [ ] If you have any keys, return them to a lab manager
* [ ] Remove any copies of lab-owned data from your personal devices
* [ ] If you accidentally are the owner of any lab-related Google Docs, please transfer ownership of these to Hua
* [ ] Provide a lab manager with permanent contact information, in case we need to reach you at some point down the road

For most people leaving the lab, we will revoke your `darlshareddrive` and Trello credentials, and convert your Slack account to a single-channel guest (on `#general`) so that you can keep in touch there. If you are continuing to collaborate with us in your next position, then please discuss with Hua how we will manage your credentials.
